...
const films = [
  {
    ...
    video: trailerPool[0],
    progress: 0,
    description: "Um ex-assassino volta à ativa em uma sequência brutal de vingança e ação estilizada.",
    fullDescription: "John Wick é um filme de ação intenso, elegante e rápido, conhecido por suas cenas de combate coreografadas, atmosfera sombria e ritmo cinematográfico marcante.",
    classification: "16+",
    quality: "4K",
    audio: "Português",
    seasons: null,
  ...
  },
  {
    ...
    banner: "https://images.unsplash.com/photo-1497032205916-ac775f0649ae?auto=format&fit=crop&w=1600&q=80",
    video: trailerPool[1],
    progress: 0,
    description: "Perseguições explosivas em um deserto caótico com visual pós-apocalíptico impressionante.",
    fullDescription: "Mad Max: Fury Road entrega ação extrema, direção visual poderosa e uma experiência intensa do começo ao fim, com sequências de perseguição memoráveis.",
    classification: "16+",
    quality: "4K",
    audio: "Português",
    seasons: null,
  ...
  },
  {
    ...
    video: trailerPool[2],
    progress: 0,
    description: "Uma jornada espacial emocionante sobre sobrevivência, tempo e laços familiares.",
    fullDescription: "Interstellar mistura ficção científica, emoção e grandiosidade visual em uma narrativa profunda sobre humanidade, espaço e esperança.",
    classification: "12+",
    quality: "4K",
    audio: "Português",
    seasons: null,
  ...
  },
  {
    ...
    banner: "https://images.unsplash.com/photo-1485846234645-a62644f84728?auto=format&fit=crop&w=1600&q=80",
    video: trailerPool[3],
    progress: 0,
    description: "Uma versão sombria e investigativa do herói em Gotham.",
    fullDescription: "The Batman combina suspense, investigação e ação em uma ambientação escura, elegante e cinematográfica, com foco no lado detetive do personagem.",
    classification: "14+",
    quality: "4K",
    audio: "Português",
    seasons: null,
  ...
  },
  {
    ...
    video: trailerPool[4],
    progress: 0,
    description: "Velocidade, emoção e combates aéreos em uma continuação vibrante.",
    fullDescription: "Top Gun: Maverick traz ação aérea de alto nível, emoção e nostalgia, com visual moderno e cenas impactantes.",
    classification: "12+",
    quality: "4K",
    audio: "Português",
    seasons: null,
...
const animes = [
  {
    ...
    banner: "https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?auto=format&fit=crop&w=1600&q=80",
    video: trailerPool[5],
    progress: 0,
    description: "Humanidade encurralada contra titãs em uma história intensa e cheia de reviravoltas.",
    fullDescription: "Attack on Titan é um anime épico com ação brutal, mistério, drama e uma narrativa crescente que prende do início ao fim.",
    classification: "16+",
    quality: "4K",
    audio: "Japonês",
    seasons: 4,
  ...
  },
  {
    ...
    banner: "https://images.unsplash.com/photo-1478720568477-152d9b164e26?auto=format&fit=crop&w=1600&q=80",
    video: trailerPool[6],
    progress: 0,
    description: "Um jovem enfrenta demônios em busca de salvar sua irmã e vingar sua família.",
    fullDescription: "Demon Slayer combina animação impressionante, lutas intensas e emoção, sendo um dos animes mais populares dos últimos anos.",
    classification: "14+",
    quality: "4K",
    audio: "Japonês",
    seasons: 3,
  ...
  },
  {
    ...
    video: trailerPool[7],
    progress: 0,
    description: "Maldições, energia amaldiçoada e batalhas frenéticas em um anime moderno e estiloso.",
    fullDescription: "Jujutsu Kaisen traz ação sobrenatural, personagens fortes e cenas de luta eletrizantes com alto nível técnico e visual.",
    classification: "16+",
    quality: "4K",
    audio: "Japonês",
    seasons: 2,
  ...
  },
  {
    ...
    year: 2002,
    note: "8.4",
    duration: "720 episódios",
    badge: "Popular",
    image: "https://image.tmdb.org/t/p/w500/vauCEnR7CiyBDzRCeElKkCaXIYu.jpg",
    banner: "https://images.unsplash.com/photo-1542204625-de293a2f8ff2?auto=format&fit=crop&w=1600&q=80",
    video: trailerPool[0],
    progress: 0,
    description: "A trajetória de um ninja determinado a conquistar respeito e se tornar o mais forte da vila.",
    fullDescription: "Naruto é um clássico dos animes shounen, com muita ação, evolução de personagens e momentos emocionantes.",
    classification: "12+",
    quality: "1080p",
    audio: "Japonês",
    seasons: 9,
  ...
  },
  {
    ...
    badge: "Novo",
    image: "https://image.tmdb.org/t/p/w500/qpRZVTNik8BQEtW5g6QfSrx6pNf.jpg",
    banner: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&w=1600&q=80",
    video: trailerPool[1],
    progress: 0,
    description: "Um caçador fraco desperta um poder único e começa sua ascensão avassaladora.",
    fullDescription: "Solo Leveling entrega visual impactante, combates intensos e uma progressão viciante de poder em um universo cheio de monstros e portais.",
    classification: "14+",
    quality: "4K",
    audio: "Japonês",
    seasons: 1,
...
function formatTime(seconds) {
  ...
  const menu = ["Início", "F", "Séries", "Animes", "Desenhos", "Minha Lista"];
